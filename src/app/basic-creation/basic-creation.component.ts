...
import { Observable, Observer, from, Subscriber, of, interval, timer, Subscription, fromEvent } from 'rxjs';
...
export class BasicCreationComponent implements OnInit {
  ...
  intervalClick() {
    ...
    const subscrition = source.subscribe((v) => console.warn(v));
